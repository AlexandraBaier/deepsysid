...
def test_linear_model():
    ...
    parameter_count = (control_dim + state_dim) * state_dim
...
def test_linear_lag():
    ...
    parameter_count = state_dim * (lag * (control_dim + state_dim))
...
def test_quadratic_control_lag():
    ...
    parameter_count = state_dim * (lag * (2 * control_dim + state_dim))
